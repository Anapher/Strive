...
const CAM_VIDEO_SIMULCAST_ENCODINGS: RtpEncodingParameters[] = [
   { rid: 's', maxBitrate: 200 * 1000, scaleResolutionDownBy: 4 /** scalabilityMode: 'S1T1' (default) */ },
   { rid: 'm', maxBitrate: 300 * 1000, scaleResolutionDownBy: 2 /** scalabilityMode: 'S1T1' (default) */ },
   { rid: 'h', maxBitrate: 3500 * 1000, scaleResolutionDownBy: 1 /** scalabilityMode: 'S1T1' (default) */ },
];
...
export default function useWebcam(loopback = false): UseWebcam {
   ...
   const getCam = async (deviceId?: string) => {
      const constraints: MediaStreamConstraints = { video: { width: { ideal: 1280 }, frameRate: 25, deviceId } };
