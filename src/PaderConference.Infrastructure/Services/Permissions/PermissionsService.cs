...
using PaderConference.Infrastructure.Services.Permissions.Messages;
...
namespace PaderConference.Infrastructure.Services.Permissions
{
    public class PermissionsService : ConferenceService, IPermissionsService
    {
        ...
        public PermissionsService(string conferenceId, IConferenceRepo conferenceRepo, IRedisDatabase redisDatabase,
            IHubClients clients, IConnectionMapping connectionMapping, IConferenceManager conferenceManager,
        ...
        {
            return new RedisPermissions(_redisDatabase, RedisKeys.ParticipantPermissions(participant.ParticipantId))
        ...
        public async ValueTask UpdatePermissions(IEnumerable<Participant> participants)
        {
            ...
            foreach (var participant in participants)
            {
                ...
                await _redisDatabase.HashSetAsync(RedisKeys.ParticipantPermissions(participant.ParticipantId),
                    permissions);
            }
